...
#ifndef PestSFDMuserChannels_DialogH
#define PestSFDMuserChannels_DialogH
//---------------------------------------------------------------------------
...
#include <vector>
//---------------------------------------------------------------------------
class TPestSFDMuserChnls : public TForm
{
...
public:		// Déclarations utilisateur
	...
	void __fastcall setPestGridParam(int idPestParam, std::vector<double> TTUMMT);
	...
	//------------------------------------------------------------------------
	__fastcall TPestSFDMuserChnls(TComponent* Owner);
};
//---------------------------------------------------------------------------
extern PACKAGE TPestSFDMuserChnls *PestSFDMuserChnls;
//---------------------------------------------------------------------------
#endif
