...
#ifndef PestMDMedAutoChannels_DialogH
#define PestMDMedAutoChannels_DialogH
//---------------------------------------------------------------------------
...
#include <vector>
//---------------------------------------------------------------------------
class TPestADEniAutoChnls : public TForm
{
...
public:		// Déclarations utilisateur
	...
	__fastcall TPestADEniAutoChnls(TComponent* Owner);
};
//---------------------------------------------------------------------------
extern PACKAGE TPestADEniAutoChnls *PestADEniAutoChnls;
//---------------------------------------------------------------------------
#endif
