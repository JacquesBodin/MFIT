...
#ifndef PestMDMiUserChannels_DialogH
#define PestMDMiUserChannels_DialogH
//---------------------------------------------------------------------------
...
#include <vector>
//---------------------------------------------------------------------------
class TPestADEiUserChnls : public TForm
{
...
public:		// Déclarations utilisateur
	...
	void __fastcall setPestGridParam(int idPestParam, std::vector<double> vTCEMM);
	...
	//------------------------------------------------------------------------
	__fastcall TPestADEiUserChnls(TComponent* Owner);
};
//---------------------------------------------------------------------------
extern PACKAGE TPestADEiUserChnls *PestADEiUserChnls;
//---------------------------------------------------------------------------
#endif
