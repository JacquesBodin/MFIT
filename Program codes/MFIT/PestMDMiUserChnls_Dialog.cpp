...
//---------------------------------------------------------------------------
void __fastcall TPestADEiUserChnls::setPestGridParam(int idPestParam, std::vector<double> vTTUMMT)
...
void __fastcall TPestADEiUserChnls::newPestTplFile()
{
  ...
  {
	vector< vector<double> > const pestUserChnlParams(getPestParams()); // a series (vector) of vTTUMMT values (Type, Channel No., Use (No=0/Yes=1), Minimum, Maximum, Transform)
