...
//---------------------------------------------------------------------------
void __fastcall TPestADEiUserChnls::setPestGridParam(int idPestParam, std::vector<double> vTCEMM)
...
void __fastcall TPestADEiUserChnls::newPestTplFile()
{
  ...
  {
	vector< vector<double> > const pestUserChnlParams(getPestParams()); // a series (vector) of vTCEMM values (Type, Channel No., Estimate (No=0/Yes=1), Minimum, Maximum)
