...
#ifndef MDP_SFDM_DialogH
#define MDP_SFDM_DialogH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TMDP_SFDM : public TMultiFlow_Generic
{
...
private:	// Déclarations utilisateur
	//------------------ Attributs privés ------------------------------------
	double m_QT;
	std::vector< std::vector<double> > m_AutoChnlSols; // solutions [n=1~nMax] (option "AutoChnls"): transport parameters for each channel of each solution
	//------------------ Méthodes privées ------------------------------------
...
public:		// Déclarations utilisateur
	...
	__fastcall TMDP_SFDM(TComponent* Owner);
};
//---------------------------------------------------------------------------
extern PACKAGE TMDP_SFDM *MDP_SFDM;
//---------------------------------------------------------------------------
#endif
